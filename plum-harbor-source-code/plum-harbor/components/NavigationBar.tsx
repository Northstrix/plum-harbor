  ...
  useEffect(() => {
    if (tooltipRef.current) {
      tippy(tooltipRef.current, {
        content: language === 'en' ? "Hebrew version" : "English version",
        placement: 'bottom',
        arrow: true,
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <div ref={tooltipRef} style={{ position: "relative", marginRight:"20px" }}> {/* Adjust margin here */}
              <img 
                src={language === 'he' ? "/Flag_of_the_United_States.svg" : "/Flag_of_Israel.svg"} // Conditional flag source
          ...
          <div style={{ backgroundColor:"transparent", paddingLeft:"10px", paddingRight:"10px", transform: language === 'he' ? 'scaleX(-1)' : 'none', }}>
                  <ChronicleButton text={t('log-in-the-verb')} width="100px" outlined={true} outlinePaddingAdjustment="4px" onClick={() => {
