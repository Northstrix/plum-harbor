...
const TabSwitcher: React.FC<{ windowWidth: number; }> = ({  }) => {
  ...
  const fullBarSwitch = i18n.language === 'he' ? 1356 : 1434;
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <Link href="/" onClick={() => setActiveTab(1)} style={{
            ...
            {(windowWidth > 1563 || (windowWidth < fullBarSwitch && windowWidth >= 768)) && (
              <span style={{
                fontSize: '24px',
                fontWeight: 'bold',
                marginLeft: '8px',
          ...
          <div style={{ backgroundColor:"transparent", paddingLeft:"10px", paddingRight:"10px", transform: i18n.language === 'he' ? 'scaleX(-1)' : 'none' }}>
            <ChronicleButton text={t('log-out-the-verb')} width="100px" outlined={true} outlinePaddingAdjustment="4px" onClick={handleLogOutConfirmation}></ChronicleButton>
          </div>
        </div>
      </nav>
