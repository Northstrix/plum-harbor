...
try {
  ...
  if (user) {
    ...
    if (docSnap.exists()) {
      ...
      if (userSettings) {
        const { setCornerRounding } = useStore.getState();
        setCornerRounding(userSettings.cornerRounding || 'Smooth');
  ...
  return (
    ...
    >
      <main className="w-full max-w-4xl">
        <div className={`h-[480px] ${i18n.language === "de" ? "w-[394px]" : "w-[374px]"} mx-auto flex items-center justify-center bg-transparent`}>
