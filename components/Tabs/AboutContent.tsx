    ...
    return (
        ...
        <div id="card" ref={cardRef} className="popup-content">
            ...
            <h2 className="title">About</h2>
                ...
                <span className="text"><a id="linkanimation" href="https://codepen.io/Juxtoposed/pen/mdQaNbG" target="_blank" rel="noopener noreferrer">Text scroll and hover effect with GSAP and clip</a> by <a id="linkanimation" href="https://codepen.io/Juxtoposed" target="_blank" rel="noopener noreferrer">Juxtoposed</a></span>
                ...
                <span className="text">
                    <a id="linkanimation" href="https://codepen.io/kristen17/pen/NPKrxBd" target="_blank" rel="noopener noreferrer">Course design cards #scss</a> by <a id="linkanimation" href="https://codepen.io/kristen17">Kristen</a>
                </span>

                <span className="text">
                    <a id="linkanimation" href="https://dribbble.com/shots/14951981-Design-Courses-Darshboard-Design/attachments/6669266?mode=media" target="_blank" rel="noopener noreferrer">Design Courses Darshboard Design</a> by <a id="linkanimation" href="https://dribbble.com/Hirariaz4">Hira Riaz🔥</a>
                </span>

                <span className="text">
                    <a id="linkanimation" href="https://codepen.io/jkantner/pen/OJKZxpv" target="_blank" rel="noopener noreferrer">Toolbars With Sliding Selection</a> by <a id="linkanimation" href="https://codepen.io/jkantner">Jon Kantner</a>
                </span>

                <span className="text">
                    <a id="linkanimation" href="https://codepen.io/yudizsolutions/pen/YzgXvZJ" target="_blank" rel="noopener noreferrer">Gsap Slider</a> by <a id="linkanimation" href="https://codepen.io/yudizsolutions">Yudiz Solutions Limited</a>
                </span>
                
                <br/><br/>

                <span className="text">
                    Homepage design is inspired by <a id="linkanimation" href="https://emailthing.app">EmailThing</a>
                </span>
            </div>
